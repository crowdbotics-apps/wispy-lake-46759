"""
Django settings for wispy_lake_46759 project.
...
ROOT_URLCONF = 'wispy_lake_46759.urls'
...
WSGI_APPLICATION = 'wispy_lake_46759.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_lake_46759 API",
    "DESCRIPTION": "API documentation for wispy_lake_46759 App",
    "VERSION": "v1",
}
